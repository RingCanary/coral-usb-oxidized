...
```bash
python3 tools/archive/usbmon_register_map.py report <usbmon.log> --bus 4 --device 005
python3 tools/archive/usbmon_register_map.py matrix --run U1=<log1> --run U2=<log2> --run U3=<log3> --run U4=<log4> --bus 4 --device 005
python3 tools/archive/usbmon_register_map.py sequence <usbmon.log> --bus 4 --device 005 --phase pre_loop --json > /tmp/vendor-seq-preloop.json
python3 tools/archive/usbmon_register_map.py sequence <usbmon.log> --bus 4 --device 005 --phase all --writes-only --json > /tmp/vendor-writes-all.json
python3 tools/archive/usbmon_register_map.py sequence <usbmon.log> --bus 4 --device 005 --phase all --writes-only --known-only --json > /tmp/vendor-writes-known.json
